    ...
    <tr>
        ...
        <td>
            <select name="client_msg.client_credit">
                <option value='<s:property value="client_msg.client_credit"/>'><s:property value="sell_chance.client_msg.client_credit"/></option>
                <option>--------</option>
                <option value="☆">☆</option>
                <option value="☆☆">☆☆</option>
                <option value="☆☆☆">☆☆☆</option>
    ...
    <tr>
        ...
        <td>
            <select name="client_msg.client_satisfaction">
             <option value='<s:property value="client_msg.client_msg.client_satisfaction"/>'><s:property value="sell_chance.client_msg.client_satisfaction"/></option>
                <option>--------</option>
                <option value="☆">☆</option>
                <option value="☆☆">☆☆</option>
                <option value="☆☆☆">☆☆☆</option>
...
<tr>
    ...
    <td><input name="client_msg.address" type="text" value='<s:property value="sell_chance.client_msg.address"/>'/><font color="#FF0000">*</font></td>
    <td style="background-color:#09C;">邮政编码</td>
    <td><input name="client_msg.postalcode" type="text" value='<s:property value="sell_chance.client_msg.postalcode"/>'/><font color="#FF0000">*</font></td>
</tr>
<tr>
    ...
    <td><input name="client_msg.fax" type="text" value='<s:property value="sell_chance.client_msg.fax"/>'/><font color="#FF0000">*</font></td>
</tr>
<tr>
    <td style="background-color:#09C;">网址</td>
    <td><input name="client_msg.url" type="text" value='<s:property value="sell_chance.client_msg.url"/>'/><font color="#FF0000">*</font></td>
    <td style="background-color:#09C;"></td>
    <td></td>
</tr>
</table>
...
<tr> 
    ...
    <td><input name="client_msg.business_license" type="text" value='<s:property value="sell_chance.client_msg.business_license"/>'/></td>
    <td style="background-color:#09C;">法人</td>
    <td><input name="client_msg.legal_man" type="text" value='<s:property value="sell_chance.client_msg.legal_man"/>'/><font color="#FF0000">*</font></td>
</tr>
<tr>
    <td style="background-color:#09C;">注册资金(万元)</td>
    <td><input name="client_msg.registered_capital" type="text" value='<s:property value="sell_chance.client_msg.registered_capital"/>'/></td>
    <td style="background-color:#09C;">年营业额</td>
    <td><input name="client_msg.year_money" type="text" value='<s:property value="sell_chance.client_msg.year_money"/>'/></td>
</tr>
<tr>
    <td style="background-color:#09C;">开户银行</td>
    <td><input name="client_msg.deposit_bank" type="text" value='<s:property value="sell_chance.client_msg.deposit_bank"/>'/><font color="#FF0000">*</font></td>
    <td style="background-color:#09C;">银行账号</td>
    <td><input name="client_msg.bank_account" type="text" value='<s:property value="sell_chance.client_msg.bank_account"/>'/><font color="#FF0000">*</font></td>
</tr>
<tr>
    <td style="background-color:#09C;">地税登记号</td>
    <td><input name="client_msg.government_rent" type="text" value='<s:property value="sell_chance.client_msg.government_rent"/>'/></td>
    <td style="background-color:#09C;">国税登记号</td>
    <td><input name="client_msg.national_tax" type="text" value='<s:property value="sell_chance.client_msg.national_tax"/>'/></td>
</tr>
</table>
