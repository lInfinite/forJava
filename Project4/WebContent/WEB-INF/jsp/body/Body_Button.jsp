   ...
   <dt><a onClick="showButton(['system_main'])">客户关系管理系统</a></dt>
       <dd id="system_main">
           ...
           <dt><a onclick="showButton(['sell_chance','sell_develop'])">营销管理</a></dt>
               <dd id="sell_chance"><a href="../sell/sell_chance.jsp" target="body_main">销售机会管理</a></dd>
           ...
           <dt><a onclick="showButton(['base_client_level','base_service_type','base_client_region','base_query_product','base_query_storage'])">基础管理</a></dt>
               ...
               <dd id="base_product_query"><a href="<%=request.getContextPath() %>/base/product" target="body_main">查询产品信息</a></dd>
               <dd id="base_storage_query"><a href="<%=request.getContextPath() %>/base/" target="body_main">查询仓库</a></dd>
